...
public class EntryrionUtil {
    ...
    public static void main(String[] args) {
        System.out.println(getHash("545690097FZQ", "MD5"));
        System.out.println(getHash("545690097FZQ", "SHA") + "\n");

        System.out.println(getHash2("545690097FZQ", "MD5"));
        System.out.println(getHash2("545690097FZQ", "SHA") + "\n");

        System.out.println(getHash3("545690097FZQ", "MD5"));
        System.out.println(getHash3("545690097FZQ", "SHA") + "\n");
    }*/
}
